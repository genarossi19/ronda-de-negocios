...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-white text-foreground dark:bg-[#11161d] dark:text-white flex h-full w-full flex-col overflow-hidden rounded-md",
        className,
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "text-[#143E29] placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50 dark:text-white dark:placeholder-[#b8c0ca]",
          className,
        )}
        {...props}
      />
